            ...
            <section id="post13 ">
                <div className='container mt-4 pb-5' style={{ background: "white", borderRadius: "10px" }}>
                    ...
                    <div className='row post_user_info py-3'>
                        ...
                        <div className="  ">
                            <h4>Flo Pharoah</h4>
                            <p>28 days ago <LanguageIcon style={{ paddingLeft: "2px" }} /> </p>
                        </div>
...
<h6>#Grandrising🧚‍♀️&🧚‍♂️!!Remember,it is not a 'mistake' for someone to treat you in a way they wouldn't want to be treated! if they cared about you enough those actions would've never ever crossed their minds!!🤞 </h6>
                    </div>
                    {/* ----------end--------Status-------- */}
                    ...
                    <div className='reactions row mt-5'>
                        ...
                        <img src='../images/love.svg' alt='react' />
                            ...
                            <img src='../images/wow.svg' alt='react' />
                            <p>6</p>
                        </div>
