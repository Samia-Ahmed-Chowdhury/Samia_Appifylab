            ...
            <div className='container mt-4 pb-5' style={{ background: "white", borderRadius: "10px" }}>
                    ...
                    <div className='row post_user_info py-3'>
                        <div className="d-flex align-items-center ">
                            <img src="../images/img3.png"  alt="img" className='user_profile  img-fluid rounded-circle' />
                        </div>
                        <div className="  ">
<h4>Sadek Hossain</h4>
                            <p>27 days ago <LanguageIcon style={{ paddingLeft: "2px" }} /> </p>
                        </div>
                    ...
                    {/* ----------Status-------- */}
                    <div className='row ' >
                        <img src='../images/post11.png' alt="img" className='img-fluid' />
                    </div>
                    {/* ----------end--------Status-------- */}
                    ...
                    <div className='reactions row mt-5'>
                        <div className= " d-flex">
                            ...
                            <img  src='../images/haha.svg' alt='react' />

                            <p>3</p>
                        </div>
                        <div className='comment_span'> # Comments</div>
                    </div>
                    {/* ----------end--------Reactions-------- */}
                    {/* -----------actions-------- */}
